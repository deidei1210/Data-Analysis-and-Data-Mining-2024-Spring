...
from dataset import getT1Loader
...
writer = SummaryWriter(f"runs/fine1_train_logs_{timestamp}")
...
def train(
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), f"models/fine1_best_model_{timestamp}.pth")
            print("Model Saved")


# 假设getLoader返回的是训练和验证数据加载器
train_loader, val_loader = getT1Loader()
# 获取一个数据批次
