...
from dataset import getT2Loader
...
writer = SummaryWriter(f"runs/fine2_train_logs_{timestamp}")
...
def train(
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), f"models/fine2_best_model_{timestamp}.pth")
            print("Model Saved")


# 假设getLoader返回的是训练和验证数据加载器
train_loader, val_loader = getT2Loader()
# 获取一个数据批次
...
# 加载预训练模型
pretrained_model_path = "models/best_model_20240613-173832.pth"
